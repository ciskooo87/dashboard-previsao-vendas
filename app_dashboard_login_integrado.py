...
usuarios = {
    "brasforma": {"senha": "123", "empresa": "Brasforma"},
    "fort": {"senha": "456", "empresa": "Fort Solutions"},
    "cepam": {"senha": "789", "empresa": "Padaria Cepam"},
    "admin": {"senha": "master", "empresa": "ALL"}
}
...
# === Seleção da empresa (admin vê todas) ===
empresas = {
