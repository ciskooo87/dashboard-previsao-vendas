...
# Estilo visual: fundo da sidebar roxo, fontes claras
st.markdown("""
    <style>
        .stApp {
        ...
        .stSidebar input, .stSidebar select, .stSidebar label, .stSidebar div {
            color: white !important;
        }
        .stButton > button {
...
aba = st.sidebar.radio("Escolha a visualização:", [ "📊 Previsão por Produto", "🏆 Ranking de Vendas", "📌 Produtos Recomendados", "📉 Análise de Churn", "🔁 Previsão de Recompra", "📦 Pedido Sugerido" ])
